...
Autogenerated from <a href=\"$play\">the original text</a> fed through <a href=\"https://github.com/kevandotorg/nanogenmo-2017\">a script</a> by <a href=\"http://kevan.org\">Kevan Davis</a> for <a href=\"https://github.com/NaNoGenMo/2017\">NaNoGenMo 2017</a>.</div>
	  ...
	  if (preg_match("/>Burthen \[dispersedly, within</",$originalLine))
	  { $originalLine = "<p><i>Burthen [dispersedly, within]: Bow-wow</i></p>"; }
	  if (preg_match("/>Burthen Bow-wow</",$originalLine))
	  { $originalLine = "<p><i>Burthen: Bow-wow</i></p>"; }
	  if (preg_match("/>Burthen Ding-dong</",$originalLine))
	  { $originalLine = "<p><i>Burthen: Ding-dong</i></p>"; }
