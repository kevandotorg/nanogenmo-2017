...
"000        " => "Call me it's an emergency! (also 999 (or) 911).",
...
"BK         " => "Because.",
"BKA        " => "Better known as.",
"BKAM       " => "Between keyboard and monitor (problem is the user).",
"BL         " => "Belly laughing.",
"BM         " => "Byte me.",
"BMA        " => "Bite my a*s.",
...
"CIAO       " => "Ciao (pronounced &quot;chow&quot;) Hello or Goodbye in Italian.",
...
"CUCME      " => "See you see me (video conference).",
"CUD        " => "Could.",
...
"DOM        " => "Dirty old man.",
"DOTGOV     " => "Government site (from the .gov domain names).",
...
"ESP        " => "Especially (usually just &quot;esp.&quot;).",
...
"FotR       " => "Fellowship of The Rings (a Tolkien book).",
...
"INT        " => "I'll never tell.",
"IOH        " => "I'm out of here.",
"IOM        " => "I open mouth (sexual connotations).",
...
"KDW        " => "Keep digging, Watson (response to NSS).",
"KEWL       " => "Cool.",
"KFY        " => "Kiss for you.",
...
"KITA       " => "Kick in the a*s  (type of therapy).",
"KK         " => "Okay, Okay.",
"KMA        " => "Kiss my a*s.",
"KMB        " => "Kiss my butt.",
...
"LBB        " => "Little black box (slang - web-tv set-box unit).",
...
"LotR       " => "Lord of The Rings (a J.R.R.Tolkien book).",
...
"N/P        " => "No problem.",
"n00b       " => "Newbie.",
"n00b       " => "Newbie (the '00's are two zeros, not 'ohs').",
"N1         " => "Nice one.",
...
"PHD        " => "Push here dummy (type of camera).",
...
"RotK       " => "Return of The King (a Tolkien book).",
...
"RTF        " => "Read The FAQ (Frequently Asked Questions).",
...
"RTFMS      " => "Read the f**king manual, sir (military).",
...
"S2BX       " => "Soon to be ex.",
"S2R        " => "Send to receive (usually pictures).",
"S4L        " => "Spam for life.",
...
"ST         " => "Star Trek (or) such that (usually just &quot;s.t.&quot;).",
"ST         " => "Super tired.",
...
"TSR        " => "Totally stupid rules (or) Terminate and stay resident (program).",
"TSWC       " => "Tell someone who cares.",
"TT         " => "Ta ta (or) take that.",
"TT         " => "The Two Towers (a Tolkien Book).",
"TT4N       " => "Ta-ta for now.",
...
"UY         " => "Up yours.",
"<vbg>      " => "very big grin.",
"VBEG       " => "Very big evil grin (usually <vbeg>).",
"VBG        " => "Very big grin.",
"VBG        " => "Very big grin (usually <vbg>).",
"VBS        " => "Very big smile.",
...
"YR         " => "Your (or) Yea, right. (Being sacastic).",
"YS         " => "You stinker.",
